...
const defaultState = {
  ...
  plannedStartText: "2026. 4. 20.",
  plannedEndText: "~ 2026. 5. 중순예정",

  task1Enabled: true,
  task1Name: "대기",
  task1Start: "2026-04-20",
  task1End: "2026-05-18",
  task1Percent: 0,
  task1Workers: 0,
  statusText1: "대기",
...
const state = {
  ...
  plannedStartText: defaultState.plannedStartText,
  plannedEndText: defaultState.plannedEndText,
...
function renderTexts() {
  planDateStartText.textContent =
    state.plannedStartText || formatDisplayDate(state.plannedStart);

  planDateEndText.textContent =
    state.plannedEndText || formatDisplayDate(state.plannedEnd, true);
